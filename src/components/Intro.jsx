        ...
        <div>
            <div className="Top-container"> 
                ...
                <div className= "tcontainer">
                    ...
                    <img className="mountain"  src= {`${PUBLIC_URL}/image/mountain.png`} alt="mountain-img"/>  
                </div>
            </div>
            <div className="middle-container">
                <div className="profile">
                <img className="my_pics" src={`${PUBLIC_URL}/image/me.jpg`} alt="Johnchizzy" width="304"height="304"/>
                <h2>Hello.</h2>
